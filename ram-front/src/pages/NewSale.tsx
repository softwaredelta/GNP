...
<div className="w-full p-2 flex justify-center items-center">
              <button className="bg-gnp-primary-blue hover:bg-gnp-primary-blue text-white font-bold flex justify-center items-center py-2 mt-4 px-4 rounded focus:outline-none focus:shadow-outline" type="submit">
